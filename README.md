## DNB Hugo Component / Errors

This is a Hugo theme component with layouts to add more versatile error pages
...
[module]
[[module.imports]]
path = "github.com/dnb-org/dnb-hugo-errors"
```
...
```shell
# update this module
hugo mod get -u github.com/dnb-org/dnb-hugo-errors
# update all modules
hugo mod get -u ./...
```
...
| [errors](https://github.com/dnb-org/components/tree/main/errors)                 |                                                            |
